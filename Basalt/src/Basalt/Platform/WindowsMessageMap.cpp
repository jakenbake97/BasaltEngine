...
Basalt::Platform::WindowsMessageMap::WindowsMessageMap()
	:
	map({
...
Basalt::String Basalt::Platform::WindowsMessageMap::operator()(DWORD msg, LPARAM lp, WPARAM wp) const
{
	...
	if (i != map.end())
	{
		oss << std::left << std::setw(firstColWidth) << i->second.Narrow() << std::right;
	}
	else
	{
